function [rocket, par] = rocket2d()
%ROCKET2D Returns a nlmodel object of a 2D rocket with only x, z and theta
% as output without the derivatives thereof.
%
...
%   Reuben Ferrante, 2017, University of Edinburgh
    ...
    % model of rocket
    rocket = nlmodel(f, h, 6, 3, 3, 'stateName', states, 'inputName', inputs, 'outputName', outputs, 'jacobians', @jacobians);
